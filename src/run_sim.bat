...
iverilog -o output.vvp fsm\fsm.v rotational_encoder\rotational_encoder.v seven_seg\seven_seg.v spi_flash\spi_flash.v spi_sensor\spi_sensor.v tt_um_csit_luks.v tt_um_csit_luks_tb.v
